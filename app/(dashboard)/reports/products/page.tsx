    ...
    <div className="space-y-6">
      ...
      <div className="hidden print:block">
        ...
        <div style={{padding:"10px 22px 8px",background:"#f8fdf8",borderBottom:"1px solid #e5e7eb",marginBottom:"8px"}}>
          <h2 style={{margin:0,fontSize:"16px",fontWeight:800,color:"#5b21b6"}}>Store Product Report</h2>
      ...
      <div className="flex flex-wrap gap-3 items-end print:hidden bg-blue-50 border border-blue-300 rounded-xl p-4">
        ...
        <Button size="sm" className="bg-white hover:bg-gray-100 text-gray-900 border border-gray-300" onClick={() => loadReport()}>
          Apply
        </Button>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                {loading ? (
                  ...
                  <tr
                    key={p.id}
                    className={`hover:bg-blue-50 ${p.isLowStock ? "bg-red-50/40" : ""}`}
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className="text-xs px-2 py-0.5 bg-blue-100 text-gray-700 rounded-full">
                        {p.category}
                      </span>
                    </td>
