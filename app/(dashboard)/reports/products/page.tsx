...
export default function ProductReportPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Date Range Filter ── */}
      <div className="flex flex-wrap gap-3 items-end print:hidden bg-slate-50 border border-yellow-300 rounded-xl p-4">
        <div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                {loading ? (
                  ...
                  <tr
                    key={p.id}
                    className={`hover:bg-slate-50 ${p.isLowStock ? "bg-red-50/40" : ""}`}
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className="text-xs px-2 py-0.5 bg-yellow-100 text-gray-700 rounded-full">
                        {p.category}
                      </span>
                    </td>
