    ...
    <div className="space-y-6">
      ...
      <div className="hidden print:block">
        ...
        <div style={{padding:"10px 22px 8px",background:"#f8fdf8",borderBottom:"1px solid #e5e7eb",marginBottom:"8px"}}>
          <h2 style={{margin:0,fontSize:"16px",fontWeight:800,color:"#5b21b6"}}>Trader Report</h2>
              ...
              <tbody>
                {loading ? (
                  ...
                  <>
                    ...
                    <tr
                      key={c.id}
                      className={`border-b border-blue-300 hover:bg-blue-50 cursor-pointer transition-colors ${expanded[c.id] ? "bg-green-50/30" : ""}`}
