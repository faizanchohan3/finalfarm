    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Link href="/reports/sales">
          <div
            className="rounded-xl p-5 text-slate-900 cursor-pointer hover:opacity-90 transition-opacity"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className={productData.lowStockCount > 0 ? "border-red-200 bg-red-50/30" : "border-slate-200"}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {visibleReportCards.map(({ href, title, description, icon: Icon, color }) => (
            <Link key={href} href={href}>
              <Card className="hover:shadow-md transition-shadow cursor-pointer border border-slate-200 group">
