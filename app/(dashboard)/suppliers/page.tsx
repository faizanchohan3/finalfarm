            ...
            <div>
              ...
              <div className="flex gap-3 items-end">
                <div className="flex-1">
                  <div className="relative border-2 border-amber-200 rounded-lg p-3 text-center hover:border-green-500 transition-colors">
        ...
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          {!detail ? (
            ...
            <div className="space-y-5">
              ...
              {/* Contact */}
              <div className="flex gap-4 text-sm text-gray-600 bg-amber-50 rounded-lg p-3">
