              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button type="button" onClick={() => setPayForm({ ...payForm, paymentType: "PAY" })}
                    className={`px-3 py-2.5 rounded-lg border text-sm font-medium transition-colors ${payForm.paymentType === "PAY" ? "bg-purple-700 text-amber-950 border-purple-700" : "bg-amber-50 text-gray-600 border-amber-200 hover:border-green-300"}`}>
                    Paid to Farmer
