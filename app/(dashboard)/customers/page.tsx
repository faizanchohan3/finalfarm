          ...
          {loading && !customers.length ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {filtered.map((c, i) => (
                    <tr key={c.id} className="border-b border-gray-50 hover:bg-amber-50 transition-colors">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                {form.image ? (
                  ...
                  <div className="w-20 h-20 rounded-full bg-amber-100 border-2 border-dashed border-gray-300 flex items-center justify-center">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className={`rounded-lg p-3 text-center ${detail.totalBalance > 0 ? "bg-red-50" : "bg-amber-50"}`}>
                  ...
                  <div className="overflow-x-auto rounded-lg border border-amber-100">
                    {selectedPayments.size > 0 && (
                      <div className="mb-3 flex items-center gap-2 bg-blue-50 p-3 rounded-lg border border-blue-200">
                        ...
                        <button onClick={showDeleteConfirmModal} className="ml-auto px-3 py-1 bg-red-600 text-amber-950 text-sm rounded hover:bg-red-700">
                          Delete Selected
                        </button>
                      </div>
                    )}
