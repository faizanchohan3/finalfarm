              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {filtered.map((p) => {
                    ...
                    return (
                      <tr key={p.id} className={`border-b border-gray-50 hover:bg-slate-50 ${isExpired ? "bg-red-50" : ""}`}>
      ...
      <Dialog open={showCatModal} onOpenChange={setShowCatModal}>
        <DialogContent className="max-w-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="divide-y divide-gray-100 max-h-64 overflow-y-auto rounded-lg border border-yellow-300">
              {categories.length === 0 && (
          ...
          {(() => {
            ...
            return (
              <div className="space-y-4">
                ...
                <div className="bg-slate-50 rounded-lg p-3 text-sm text-gray-600 flex justify-between">
