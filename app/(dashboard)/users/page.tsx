          ...
          {loading && !users.length ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {users.map((u) => (
                    <tr key={u.id} className={`border-b border-gray-50 hover:bg-slate-50 ${!u.isActive ? "opacity-50" : ""}`}>
                      ...
                      <td className="py-3 px-3">
                        <span className={`text-xs px-2 py-0.5 rounded-full ${u.isActive ? "bg-green-100 text-purple-700" : "bg-yellow-100 text-gray-600"}`}>
