...
import { Eye, EyeOff, Loader2, CheckCircle, Zap, CheckCircle2, BarChart3, Lock, Zap as ZapIcon, ShoppingBag } from "lucide-react"
              ...
              {regSuccess ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-500 text-sm mb-6">
                    Your shop <strong>{reg.shopName}</strong> has been registered and is pending approval. You will be able to login once the platform admin approves your shop.
                  </p>
                  <Button
