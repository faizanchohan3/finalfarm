...
export function SearchableSelect({
  ...
  return (
    <Select value={value || undefined} onValueChange={onValueChange} disabled={disabled}>
      <SelectTrigger className={cn("w-full border-2 border-yellow-300 hover:border-green-500 transition-colors", className)}>
        {value ? (
      ...
      <SelectContent side={side} className="w-[--radix-select-trigger-width] min-w-[200px]">
        {searchable && (
          <div className="p-2 border-b sticky top-0 bg-slate-50 z-50">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-8 h-8 text-sm border-yellow-300"
