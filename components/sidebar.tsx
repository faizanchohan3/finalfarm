...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "relative flex flex-col bg-white text-amber-950 transition-all duration-300 h-screen overflow-hidden border-r border-amber-200",
        collapsed ? "w-16" : "w-64"
      )}
    >
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 py-5 border-b border-amber-200 flex-shrink-0">
        <div className="flex-shrink-0 w-8 h-8 rounded-lg overflow-hidden flex items-center justify-center bg-amber-300">
          {shopLogo ? (
            ...
            return (
              <div key={href}>
                ...
                >
                  ...
                  {!collapsed && (
                    <button
                      ...
                      className="pr-3 py-2.5 text-amber-100 hover:text-amber-950 transition-colors"
                ...
                {!collapsed && (
                  ...
                  >
                    <div className="ml-4 mt-1 border-l-2 border-amber-200 pl-3 pb-1 space-y-0.5">
                          ...
                          <Link
                            ...
                            className={cn(
                              ...
                              subActive
                                ...
                                : "text-amber-100 hover:bg-amber-100 hover:text-amber-950"
                            )}
                          >
                            {sub.label}
                          </Link>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? "bg-amber-100 text-amber-950" : "text-green-100 hover:bg-amber-100 hover:text-amber-950"
              )}
            >
      ...
      <button
        ...
        className="absolute -right-3 top-20 w-6 h-6 bg-amber-100 border border-amber-200 rounded-full flex items-center justify-center hover:bg-amber-100 transition-colors"
      >
        {collapsed ? (
